  ...
  return (
    <div className="min-h-screen bg-black relative">
      ...
      <div className="absolute top-0 left-0 right-0 z-10 flex items-center justify-between p-4 bg-gradient-to-b from-black/50 to-transparent">
        ...
        <h1 className="text-white font-medium">撮影ガイド</h1>
        <div className="w-10" />
      </div>
      ...
      <Dialog open={showPreview} onOpenChange={setShowPreview}>
        <DialogContent className="max-w-sm p-0 bg-black border-0">
          <DialogHeader className="p-4 pb-0">
            <DialogTitle className="text-white text-center">撮影確認</DialogTitle>
          </DialogHeader>
          <div className="p-4">
            {capturedImage && (
              <img src={capturedImage || "/placeholder.svg"} alt="撮影画像" className="w-full rounded-lg" />
            )}
